...
schema:
  ...
  description: A manual for adapting the AI Frontmatter Injector by modifying its
    knowledge base, master prompt, and validation workflows to match a custom metadata
    model.
  inLanguage: en
  keywords:
  - configuration
